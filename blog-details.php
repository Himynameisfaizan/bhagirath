        ...
        <div class="row">
            ...
            <div class="col-lg-8 pe-lg-5">
                <div class="blog-details-content">
                    ...
                    <!-- Dynamic HTML Content (Description) -->
                    ...
                    <div class="sidebar-widget">
                        ...
                        if (mysqli_num_rows($recentQuery) > 0) {
                            while ($recentBlog = mysqli_fetch_assoc($recentQuery)):
                                ...
                                $r_img = !empty($recentBlog['image']) ? 'uploads/' . $recentBlog['image'] : 'https://images.unsplash.com/photo-1615486171448-4228965f7c32?q=80&w=200';
                        ?>
